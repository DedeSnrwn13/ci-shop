		...
		<div class="collapse navbar-collapse" id="navbarCollapse">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item dropdown">
					<a href="" class="nav-link dropdown-toggle" id="dropdown-1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						Manage
					</a>
			...
			<ul class="navbar-nav">
				<li class="nav-item">
					<a href="<?= base_url('/cart') ?>" class="nav-link">
						<i class="fas fa-shopping-cart"></i> Cart (<?= getCart() ? getCart() : 0; ?>)
					</a>
				</li>
